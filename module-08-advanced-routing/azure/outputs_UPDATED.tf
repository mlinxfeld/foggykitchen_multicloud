...
output "bastion_vm2_public_ip" {
  description = "The public IP address of the Bastion VM2"
  value       = azurerm_public_ip.foggykitchen_bastion2_public_ip.ip_address
}
...
output "analytical_vm_private_ip" {
  description = "The private IP address of Analytical VM"
  value = azurerm_network_interface.foggykitchen_analytical_nic.private_ip_address
}
