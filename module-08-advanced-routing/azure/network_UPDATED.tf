...
resource "azurerm_virtual_network" "foggykitchen_vnet4" {
  name                = "foggykitchen-vnet4"
...
resource "azurerm_virtual_network_peering" "foggykitchen_vnet1_to_vnet4_peering" {
  name                      = "foggykitchen_vnet1_to_vnet4_peering"
  resource_group_name       = azurerm_resource_group.foggykitchen_rg1.name
  virtual_network_name      = azurerm_virtual_network.foggykitchen_vnet1.name
  remote_virtual_network_id = azurerm_virtual_network.foggykitchen_vnet4.id
  allow_forwarded_traffic   = true
  allow_virtual_network_access = true
}

resource "azurerm_virtual_network_peering" "foggykitchen_vnet4_to_vnet1_peering" {
  name                      = "foggykitchen_vnet4_to_vnet1_peering"
  resource_group_name       = azurerm_resource_group.foggykitchen_rg2.name
  virtual_network_name      = azurerm_virtual_network.foggykitchen_vnet4.name
  remote_virtual_network_id = azurerm_virtual_network.foggykitchen_vnet1.id
  allow_forwarded_traffic   = true
  allow_virtual_network_access = true
}

resource "azurerm_virtual_network_peering" "foggykitchen_vnet3_to_vnet4_peering" {
  name                      = "foggykitchen_vnet3_to_vnet4_peering"
  resource_group_name       = azurerm_resource_group.foggykitchen_rg2.name
  virtual_network_name      = azurerm_virtual_network.foggykitchen_vnet3.name
  remote_virtual_network_id = azurerm_virtual_network.foggykitchen_vnet4.id
  allow_forwarded_traffic   = true
...
resource "azurerm_virtual_network_peering" "foggykitchen_vnet4_to_vnet3_peering" {
  name                      = "foggykitchen_vnet4_to_vnet3_peering"
  resource_group_name       = azurerm_resource_group.foggykitchen_rg2.name
  virtual_network_name      = azurerm_virtual_network.foggykitchen_vnet4.name
  remote_virtual_network_id = azurerm_virtual_network.foggykitchen_vnet3.id
  allow_forwarded_traffic   = true
...
resource "azurerm_virtual_network_peering" "foggykitchen_vnet2_to_vnet4_peering" {
  name                      = "foggykitchen_vnet2_to_vnet4_peering"
  resource_group_name       = azurerm_resource_group.foggykitchen_rg1.name
  virtual_network_name      = azurerm_virtual_network.foggykitchen_vnet2.name
  remote_virtual_network_id = azurerm_virtual_network.foggykitchen_vnet4.id
  allow_forwarded_traffic   = true
...
resource "azurerm_virtual_network_peering" "foggykitchen_vnet4_to_vnet2_peering" {
  name                      = "foggykitchen_vnet4_to_vnet2_peering"
  resource_group_name       = azurerm_resource_group.foggykitchen_rg2.name
  virtual_network_name      = azurerm_virtual_network.foggykitchen_vnet4.name
  remote_virtual_network_id = azurerm_virtual_network.foggykitchen_vnet2.id
  allow_forwarded_traffic   = true
...
resource "azurerm_subnet" "foggykitchen_private_subnet2" {
  name                 = "foggykitchen_private_subnet2"
  resource_group_name  = azurerm_resource_group.foggykitchen_rg2.name
  virtual_network_name = azurerm_virtual_network.foggykitchen_vnet4.name
...
resource "azurerm_nat_gateway" "foggykitchen_nat_gw2" {
  name                = "foggykitchen_nat_gw2"
  location            = azurerm_resource_group.foggykitchen_rg2.location
  resource_group_name = azurerm_resource_group.foggykitchen_rg2.name
  sku_name            = "Standard"
}

resource "azurerm_public_ip" "foggykitchen_natgw2_public_ip" {
  name                = "foggykitchen-natgw2-ip"
  location            = azurerm_resource_group.foggykitchen_rg2.location
  resource_group_name = azurerm_resource_group.foggykitchen_rg2.name
  allocation_method   = "Static"
  sku                 = "Standard"
...
resource "azurerm_nat_gateway_public_ip_association" "foggykitchen_natgw2_ip_assoc" {
  nat_gateway_id       = azurerm_nat_gateway.foggykitchen_nat_gw2.id
  public_ip_address_id = azurerm_public_ip.foggykitchen_natgw2_public_ip.id
}

resource "azurerm_subnet_nat_gateway_association" "private_nat2_assoc" {
  subnet_id      = azurerm_subnet.foggykitchen_private_subnet2.id
  nat_gateway_id = azurerm_nat_gateway.foggykitchen_nat_gw2.id
}
...
resource "azurerm_network_interface" "foggykitchen_analytical_nic" {
  name                = "fkanalytical-nic"
  location            = azurerm_resource_group.foggykitchen_rg2.location
  resource_group_name = azurerm_resource_group.foggykitchen_rg2.name
