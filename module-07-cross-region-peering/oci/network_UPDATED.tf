...
resource "oci_core_drg_attachment" "foggykitchen_drg1_attachment" {
  provider       = oci.region1
  display_name   = "foggykitchen_drg1_attachment"
  drg_id         = oci_core_drg.foggykitchen_drg1.id
  vcn_id         = oci_core_vcn.foggykitchen_vcn1.id
}

resource "oci_core_remote_peering_connection" "foggykitchen_rpc1" {
  provider         = oci.region1
  compartment_id   = oci_identity_compartment.foggykitchen_compartment.id
  drg_id           = oci_core_drg.foggykitchen_drg1.id
  display_name     = "foggykitchen_rpc1"
  peer_id          = oci_core_remote_peering_connection.foggykitchen_rpc2.id
...
resource "oci_core_remote_peering_connection" "foggykitchen_rpc2" {
  provider       = oci.region2
  compartment_id = oci_identity_compartment.foggykitchen_compartment.id
  drg_id         = oci_core_drg.foggykitchen_drg2.id
  display_name   = "foggykitchen_rpc2"
}
